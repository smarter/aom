...
EXAMPLES-$(CONFIG_DECODERS)        += emscripten_decoder.c
emscripten_decoder.GUID             = FA46A420-3356-441F-B0FD-60AA1345C181
emscripten_decoder.SRCS            += ivfdec.h ivfdec.c
emscripten_decoder.SRCS            += tools_common.h tools_common.c
emscripten_decoder.SRCS            += video_common.h
emscripten_decoder.SRCS            += video_reader.h video_reader.c
emscripten_decoder.SRCS            += aom_ports/mem_ops.h
emscripten_decoder.SRCS            += aom_ports/mem_ops_aligned.h
emscripten_decoder.SRCS            += aom_ports/msvc.h
emscripten_decoder.DESCRIPTION      = Emscripten decoder loop
