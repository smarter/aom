...
EXAMPLES-$(CONFIG_DECODERS)        += analyzer_decoder.c
analyzer_decoder.GUID             = FA46A420-3356-441F-B0FD-60AA1345C181
analyzer_decoder.SRCS            += ivfdec.h ivfdec.c
analyzer_decoder.SRCS            += tools_common.h tools_common.c
analyzer_decoder.SRCS            += video_common.h
analyzer_decoder.SRCS            += video_reader.h video_reader.c
analyzer_decoder.SRCS            += aom_ports/mem_ops.h
analyzer_decoder.SRCS            += aom_ports/mem_ops_aligned.h
analyzer_decoder.SRCS            += aom_ports/msvc.h
analyzer_decoder.DESCRIPTION      = Analyzer decoder loop
